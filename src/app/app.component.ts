...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
    var chart = (this.chart = am4core.create('chartdiv_1', am4charts.XYChart));
    var dateAxis = chart.xAxes.push(new am4charts.DateAxis());
    // var dateAxis2 = chart.xAxes.push(new am4charts.DateAxis());
    // var consumptionAxis = chart.yAxes.push(new am4charts.ValueAxis());
    var demandAxis = chart.yAxes.push(new am4charts.ValueAxis());
    demandAxis.renderer.opposite = true;
    // var weatherAxis = chart.yAxes.push(new am4charts.ValueAxis());

    // var consumptionSeries = chart.series.push(new am4charts.ColumnSeries());
    var demandSeries = chart.series.push(new am4charts.LineSeries());
    // var weatherSeries = chart.series.push(new am4charts.LineSeries());

    // var consumptionSeries2 = chart.series.push(new am4charts.ColumnSeries());
    var demandSeries1 = chart.series.push(new am4charts.LineSeries());
    // var weatherSeries2 = chart.series.push(new am4charts.LineSeries());
